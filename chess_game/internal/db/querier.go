...
type Querier interface {
	...
	CreateGameAsBlack(ctx context.Context, arg CreateGameAsBlackParams) (Game, error)
	CreateGameAsWhite(ctx context.Context, arg CreateGameAsWhiteParams) (Game, error)
	...
	ListLiveGames(ctx context.Context) ([]ListLiveGamesRow, error)
